...
function draw() {
    ...
    */
    ...
    job = setTimeout("draw()", 2);
}

//function drawWithInputValue() {

   //var txtSpeed = document.getElementById('txtSpeed');
//var txtSpeed = 0; // Default value, you can change this to any default value you want
// Prompt the user to enter a value
// Convert the user input (which is a string) to a number using parseInt
//txtSpeed = parseInt("30");
  //  if (txtSpeed !== null) {
        ...
        numberDiv.textContent = iTargetSpeed;
